...
public class Refund {
    public static Dollar amountRefund(String contract, List<Reclamation> reclamations) throws ApplicationException, InvalidDataException {
    ...
    private static Dollar contractA(List<Reclamation> reclamations) throws ApplicationException, InvalidDataException {
        for (Reclamation reclamation : reclamations) {
            if ("0".equals(reclamation.healthCare())) return treatmentA0(reclamation.amount());
        }
        ...
        throw new ApplicationException("Catégorie de soin inattendue.");
    }

    private static Dollar treatmentA0(String amountSpent) throws InvalidDataException {
        Dollar reclamation = new Dollar(amountSpent);
        Dollar refund = reclamation.calculatePercentage(25);
        if (refund.isGreaterThan(40)) return new Dollar("40.00$");
        return refund;
    }
